...
TCP_NETSTAT=$(netstat -at)
echo "Press 12 to check TCP_NETSTAT"

UDP_NETSTAT=$(netstat -au)
echo "Press 13 to check UDP_NETSTAT"

WHO_IS_LOGGED_ON=$(w)
echo "Press 14 to check WHO_IS_LOGGED_ON"
